...
function GenerateContent() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="fixed top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full bg-cyan-500/5 blur-3xl pointer-events-none" />
...
export default function GeneratePage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-ocean-dark flex items-center justify-center text-white/40">Loading…</div>}>
      <GenerateContent />
    </Suspense>
  );
}
